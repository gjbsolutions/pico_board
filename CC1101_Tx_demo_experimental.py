...
gdo0 = machine.Pin(10, machine.Pin.IN)

spi = machine.SPI(1, baudrate=50000, polarity=0, phase=0, sck=machine.Pin(14),
                  mosi=machine.Pin(15),
                  miso=machine.Pin(12))
...
def readSingleByte(address):
    ...
    cs.value(0)
    spi.write(bytes([databuffer[0]]))
    spi.readinto(databuffer)
    cs.value(1)
    return databuffer[0]
...
def readBurst(start_address, length):        
    ...
    cs.value(0)
    spi.write_readinto(bytearray(databuffer), ret)
    cs.value(1)
    return ret
...
# 'Preamble + sync word' + 'Data'
bitstring = (""
             "1111011111111111111111111111111111111111111111111111111111111111111110100110101010101010010101100110010110011010100110101001101001011001101010100101100110010110101010100101011010001111")
